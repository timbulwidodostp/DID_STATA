...
{viewerjumpto "Syntax" "ggdid##syntax"}{...}
{viewerjumpto "Description" "ggdid##description"}{...}
{viewerjumpto "Author" "ggdid##author"}{...}
{viewerjumpto "References" "ggdid##references"}{...}
{viewerjumpto "Examples" "ggdid##examples"}{...}
{title:att_gt}
